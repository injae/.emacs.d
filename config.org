...
** FlySpell
 #+BEGIN_SRC emacs-lisp
   ...
   :bind   (:map flyspell-mode-map ([remap flyspell-correct-word-before-point] . flyspell-correct-previous-word-generic)))
   :config (evil-leader/set-key "ss" 'flyspell-correct-word-generic)
   )
